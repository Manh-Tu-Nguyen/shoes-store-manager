...
import com.example.backend.service.productService.CategoryService;
...
public class CategoryController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Map<String, Object>> update(@PathVariable Integer id, @Valid @RequestBody CategoryDTO dto) {
