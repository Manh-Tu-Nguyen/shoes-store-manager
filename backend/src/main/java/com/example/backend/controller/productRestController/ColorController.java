...
import com.example.backend.service.productService.ColorService;
...
public class ColorController {
    ...
    @PostMapping
    public ResponseEntity<Map<String, Object>> create(@Valid @RequestBody ColorDTO dto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(Map.of("success", true, "data", service.create(dto)));
    }

    @PutMapping("/{id}")
    public ResponseEntity<Map<String, Object>> update(@PathVariable Integer id, @Valid @RequestBody ColorDTO dto) {
